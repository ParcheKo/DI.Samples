...
namespace Samples.DI.CastleWindsor.ConsoleApp.Features
{
    class Default
    {
        ...
        private static void ServiceOptionsDemo2()
        {
            ...
            System.Console.WriteLine(calculator.Calculate(200));
        }
        ...
        private static void MultipleImplementation()
        {
            ...
            System.Console.WriteLine("----- Multiple Implemantation Services -----------");
            ...
            System.Console.WriteLine("----- Multiple Implemantation Service ------------");
            System.Console.WriteLine(myService.Value);
        }
        ...
        private static void MultipleImplementationWithTry()
        {
            ...
            System.Console.WriteLine("----- Multiple Implemantation Try ----------------");
        ...
        private static void InstanceRegistrationDemo()
        {
            ...
            foreach (ServiceDescriptor service in services)
            {
                if (service.ServiceType == typeof(MyInstance))
                {
                    ...
                    System.Console.WriteLine("Registered instance : " + registeredInstance.Value);
                }
            }
            ...
            System.Console.WriteLine("Registered service by instance registration : " + myInstance.Value);
        }
        ...
        private static void Demo2()
        {
            ...
            System.Console.WriteLine();
            System.Console.WriteLine("-------- 1st Request --------");
            System.Console.WriteLine();
            ...
            System.Console.WriteLine();
            System.Console.WriteLine("-------- 2nd Request --------");
            System.Console.WriteLine();
    ...
    public class MyServiceDependency : IMyServiceDependency
    {
        public void DoIt()
        {
            System.Console.WriteLine("Hello from MyServiceDependency");
        }
    }
    ...
    public class TransientDateOperation
    {
        ...
        {
            System.Console.WriteLine("Transient service is created!");
        }
    }
    ...
    public class ScopedDateOperation
    {
        ...
        {
            System.Console.WriteLine("Scoped service is created!");
        }
    }
    ...
    public class SingletonDateOperation
    {
        ...
        {
            System.Console.WriteLine("Singleton service is created!");
        }
    }
}
